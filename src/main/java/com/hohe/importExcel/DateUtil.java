...
public class DateUtil {
	...
	public static String convertDateToStringSafe(Date date, String format) {
		if (date == null) {
			return null;
		}
	...
	public static List<Date> getDateListAfterDates(Date date, int nums) {
	...
	public static String convertDateToString2(Date date, String format) {
		if (date != null) {
			SimpleDateFormat sdf = new SimpleDateFormat(format);
			return sdf.format(date);
		}
